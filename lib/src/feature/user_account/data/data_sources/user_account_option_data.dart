...
import 'package:eshopy/src/feature/user_account/presentation/pages/account_option_pages/complete_order_page.dart';
...
import 'package:eshopy/src/feature/user_account/presentation/pages/account_option_pages/my_order_page.dart';
...
class UserAccountoptiondata{
    ...
    return [
      ...
      OptionModel(icon: Appicon.myOrder, name: 'My order',navigateTo: const Myorder()),
      OptionModel(icon: Appicon.completeOrder, name: 'Complete order',navigateTo: const Completorder()),
